...
class RoomView(LoginRequiredMixin, UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context.update({
            ...
            'AZURE_SPEECH_SERVICE_API_KEY': settings.AZURE_SPEECH_SERVICE_API_KEY,
            'AZURE_SPEECH_SERVICE_REGION': settings.AZURE_SPEECH_SERVICE_REGION,
            'AZURE_SPEECH_SERVICE_LANGUAGE': settings.AZURE_SPEECH_SERVICE_LANGUAGE,
            'IS_USE_SIDENAV':      True,
            'IS_NO_USE_CONTEINER': True,
        })
        return context
